...
public class Sensor_A extends Sensor implements Detectable{
    public Sensor_A(String sensorID, String sensorType, String sensorStatus, Location location, boolean transmittingAuthority, ArrayList<Integer> decodedParticles, ArrayList<Particle> detectedParticles) {
